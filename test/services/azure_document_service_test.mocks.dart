...
// in carlog/test/services/azure_document_service_test.dart.
...
import 'package:carlog/services/image_compression_service.dart' as _i8;
...
/// A class which mocks [ImageCompressionService].
///
/// See the documentation for Mockito's code generation for more information.
class MockImageCompressionService extends _i1.Mock
    implements _i8.ImageCompressionService {
  MockImageCompressionService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<List<int>> compressImageFile(_i3.File? imageFile) =>
      (super.noSuchMethod(
            Invocation.method(#compressImageFile, [imageFile]),
